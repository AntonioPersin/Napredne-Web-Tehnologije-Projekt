...
<main>
    <section>
        ...
        <article>
            ...
            <p>Several different editions of the Dungeons & Dragons (D&D) fantasy role-playing game have been produced since 1974.
            The current publisher of D&D, Wizards of the Coast, produces new materials only for the most current edition of the game.
            However, many D&D fans continue to play older versions of the game and some third-party companies continue to publish
            materials compatible with these older editions.</p>

            <p>After the original edition of D&D was introduced in 1974, the game was split into two branches in 1977:
            ...
            <h2>First edition</h2>
            <p>The original D&D was published as a box set in 1974 and features only a handful of the elements for which the game is 
            known today: just three character classes (fighting-man, magic-user, and cleric); four races (human, dwarf, elf, and 
            hobbit); only a few monsters; only three alignments (lawful, neutral, and chaotic). With a production budget of only 
            ...
            <p>The rules assume that players own and play the miniatures wargame Chainmail and use its measurement and combat systems.
            An optional combat system is included within the rules that later developed into the sole combat system of later versions
            ...
            <p>Supplements such as Greyhawk, Blackmoor, Eldritch Wizardry and Gods, Demi-Gods & Heroes, published over the next two years,
            greatly expanded the rules, character classes, monsters and spells. For example, the original Greyhawk supplement introduced
            the thief class, and weapon damage varying by weapon (as opposed to character class). In addition, many additions and options
            were published in the magazines The Strategic Review and its successor, The Dragon.</p>
        </article>
    </section>
</main>
";
